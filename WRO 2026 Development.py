...
class Robot:
    ...
    def yellow_towers_task(self):
        ...
        wait(100)
        self.gyro_straight(-135, speed=200)
        self.move_arm(37)
        wait(100)
        ...
        self.update_grabber()
        wait(100)
        self.gyro_straight(-420, speed=200)
        wait(100)
        self.gyro_turn(92, speed=100)
        wait(100)
        self.gyro_straight_acc(400, speed=400)
        wait(100)
        ...
        wait(100)
        self.move_arm(-164, speed=300)
        wait(100)
        self.gyro_straight(140, speed=200)
        wait(100)
        self.move_arm(-106, speed=100)
        wait(100)
        self.spread()
        wait(100)
        self.gyro_straight(-280)
    ...
    def run(self):
        ...
        self.release()
        self.move_arm(37, wait=False)
        self.line_follow(5000, target_color="blue", Kp=5, speed=175)
        wait(200)
        self.gyro_straight(50, speed=60)
        wait(100)
        self.gyro_turn(-91)
        wait(100)
