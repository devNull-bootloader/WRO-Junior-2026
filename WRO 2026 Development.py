...
class Robot:
    ...
    def gyro_turn(self, angle, speed=300, timeout_ms=None):
        try:
            self.hub.imu.reset_heading(0)
        except Exception:
            pass
    ...
    def spread(self, angle=64, speed=300):
    ...
    def yellow_towers_task(self):
        ...
        wait(100)
        self.gyro_turn(91.5, speed=80)
        wait(100)
        self.gyro_straight(400, speed=300)
        wait(100)
        self.start_spread_towers()
        wait(1000)
        self.update_grabber()
        ...
        self.release()
        wait(500)
        self.gyro_straight(-100, speed=200)
        wait(100)
        self.gyro_turn(-91, speed=200)
        wait(100)
        self.gyro_straight(60, speed=200)
        wait(100)
        self.gyro_turn(91, speed=200)
        wait(100)
        self.spread()
        ...
        wait(200)
        self.gyro_straight(-90, speed=200)
        wait(100)
        self.gyro_turn(-91, speed=200)
        wait(100)
        self.up_motor.reset_angle(0)
        ...
        wait(100)
        self.up_motor.reset_angle(0)
        self.up_motor.run_target(200, 90)
        wait(100)
        self.spread()
        wait(100)
        self.gyro_straight(-280, speed=200)
        wait(100)
        self.gyro_turn(91, speed=200)
        wait(100)
        self.gyro_straight(120, speed=200)
        wait(100)
        self.up_motor.reset_angle(0)
        self.up_motor.run_target(200, 102)
        wait(100)
        self.start_grab_towers()
        wait(1500)
        self.update_grabber_grab()
        ...
        self.up_motor.run_target(200, -192)
        wait(100)
        self.gyro_straight_acc(100, speed=150)
        wait(100)
        self.up_motor.reset_angle(0)
        self.up_motor.run_target(200, 90)
        wait(100)
        self.spread()
        wait(100)
        self.gyro_straight(-180, speed=200)
        wait(100)
    ...
    def run(self):
        ...
        self.up_motor.run_target(200, 102)
        wait(200)
        self.line_follow(5000, speed=175, target_color="blue")
        wait(200)
        self.gyro_straight(60, speed=60)
        wait(100)
        self.gyro_turn(-91)
        wait(100)
        self.gyro_straight(350)
        ...
        wait(100)
        self.gyro_straight_acc(910, speed=300)
        wait(100)
        self.drive_until_color("blue")
        wait(200)
        self.gyro_turn(-25)
        ...
        self.line_follow(5000, target_color="blue", speed=150)
        wait(200)
        self.gyro_straight(280, speed=300)
        wait(100)
        self.gyro_turn(-91, speed=400)
        wait(100)
        ...
        self.gyro_turn(-93)
        wait(100)
        self.gyro_straight_acc(300)
        self.line_follow(5000, target_color="red")
        self.release_towers()
        self.release()
        self.gyro_straight(-70, speed=700)
        wait(100)
        self.gyro_turn(-30, speed=500)
        wait(100)
        self.gyro_straight(90, speed=700)
        wait(100)
        self.gyro_turn(-156, speed=500)
        self.up_motor.reset_angle(0)
        self.up_motor.run_target(200, -192, wait=False)
        wait(100)
        self.gyro_straight(700, speed=700)
        wait(100)
        self.gyro_straight_acc(-300, speed=600)
        print(stopwatch.time())
        stopwatch.pause()
