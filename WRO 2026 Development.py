...
class Robot:
    ...
    def yellow_towers_task(self):
        ...
        wait(100)
        self.gyro_straight(-137, speed=150)
        self.up_motor.reset_angle(0)
        ...
        self.update_grabber()
        wait(100)
        self.gyro_straight(-435, speed=130)
        wait(100)
        self.gyro_turn(91, speed=90)
        wait(100)
        ...
        self.update_grabber_grab()
        wait(100)
        self.gyro_straight(-115, speed=300)
        wait(100)
        self.gyro_turn(91)
        wait(100)
        self.up_motor.reset_angle(0)
    ...
    def run(self):
        ...
        wait(1000)
        self.update_grabber()
        self.gyro_straight(-360, speed=400)
        wait(100)
        ...
        wait(200)
        self.gyro_turn(-27.5, tuning=3)
        wait(100)
        self.gyro_straight(220, speed=400)
        self.release_towers()
        self.release()
        wait(100)
        ...
        wait(100)
        self.gyro_straight_acc(225, speed=400)
        self.spread()
        self.gyro_straight(-90, speed=400)
        wait(100)
